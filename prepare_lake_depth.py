...
Numeric depths are NOT inferred by this utility. If a lake has a custom
precomputed depth grid, place it beside the overlay as:
...
def main():
    ...
    metadata = {
        ...
        "opacity": opacity,
        "depth_grid": "depth_grid.npz",
        "depth_estimation": (
            "Numeric depth is read only from a precomputed static depth_grid.npz; "
            "the GUI does not infer depth from overlay contours."),
    ...
    print("  numeric depth: add a precomputed depth_grid.npz to this lake folder")
